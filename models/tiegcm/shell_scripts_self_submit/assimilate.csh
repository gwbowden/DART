...
echo "STEP 2: Clear out previous results to avoid using stale information."
...
echo "STEP 3: Get the right observation sequence file for this date/time."
...
set TIMESTAMP = `printf %04d%03d%02d $YEAR $DOY $HOUR`
...
echo "STEP 4: [OPTIONAL] prepare for DART INFLATION."
...
echo "STEP 5: assimilate the ensemble of new states."

${MPI_RUN_CMD} ./filter || exit 5
...
echo "STEP 6: Tag the output with the valid time of the model state."
...
${MOVE} Posterior_Diag.nc Posterior_Diag.nc.$TIMESTAMP
${MOVE} Prior_Diag.nc Prior_Diag.nc.$TIMESTAMP
